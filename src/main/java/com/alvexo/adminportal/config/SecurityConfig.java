...
/**
 * Real JWT admin auth: every endpoint requires a valid admin token except
 * /api/auth/login and API docs. Role-specific restrictions (e.g. Operations
 * Admin / Super Admin only) are applied per-controller via @PreAuthorize —
 * this class only decides authenticated-vs-not.
 */
@Configuration
@EnableWebSecurity
